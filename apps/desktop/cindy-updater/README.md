...
reason for keeping it closed no longer applies. A second updater that never
owned the lock does not relaunch or delete it. Failures before UAC on a protected install directory do not
